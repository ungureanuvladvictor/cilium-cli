...
var (
	// DeprecatedFlagsToHelmOpts maps the deprecated install flags to the helm
	// options
	DeprecatedFlagsToHelmOpts = map[string]string{
	...
	// DeprecatedFlagsValues maps all flags to their values
	DeprecatedFlagsValues = map[string]pflag.Value{}
)
